  ...
  return (
    ...
    >
      ...
      <div className="p-4 flex flex-col flex-1">
        ...
        <div className="flex items-center gap-1 text-xs text-amber-500 font-semibold mb-2 mt-3">
          <span>⭐</span>
          <span>{course.ratingAverage !== undefined ? course.ratingAverage.toFixed(1) : "0.0"}</span>
          <span className="text-gray-400 dark:text-gray-500 font-normal">({course.ratingCount ?? 0} đánh giá)</span>
        </div>
