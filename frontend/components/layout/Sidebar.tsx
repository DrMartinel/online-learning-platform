...
export default function Sidebar() {
  ...
  return (
    <aside
      ...
      className={`relative hidden md:flex flex-col h-screen sticky top-0 border-r border-gray-200 dark:border-gray-800 bg-white dark:bg-gray-900 transition-all duration-300 z-30 shrink-0 ${
    ...
    >
      ...
      <div className="flex-1 py-6 px-4 space-y-1.5 overflow-y-auto">
        {navItems.map((item) => {
          ...
          // Active check: exact match for Home ("/"), otherwise startsWith for nested pages (e.g. /courses/create should match /courses)
