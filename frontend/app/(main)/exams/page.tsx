    ...
    <div className="space-y-8 max-w-7xl mx-auto px-4 md:px-0 py-8">
      ...
      <div className="relative">
        ...
        <input
          ...
          className="w-full pl-12 pr-4 py-4 bg-white dark:bg-gray-900 border border-gray-150 dark:border-gray-800 rounded-2xl shadow-sm text-gray-900 dark:text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-primary focus:border-transparent transition-all"
        />
      </div>
          ...
          <button
            ...
            className={`px-4 py-2 rounded-xl text-xs font-semibold transition-all duration-200 ${
              selectedTag === tag
                ...
                : 'bg-white dark:bg-gray-900 text-gray-600 dark:text-gray-400 border border-gray-150 dark:border-gray-800 hover:bg-gray-50 dark:hover:bg-gray-800'
            }`}
          >
            {tag}
          </button>
        ...
        {loading ? (
          ...
          <div className="overflow-x-auto">
            <table className="w-full text-left border-collapse">
              <thead>
                <tr className="border-b border-gray-150 dark:border-gray-800 text-xs font-bold text-gray-400 uppercase tracking-wider bg-gray-50/50 dark:bg-gray-800/20">
                    ...
                    <td className="px-6 py-5 text-right">
                      <div className="flex items-center justify-end gap-2.5">
                        <Link
                          ...
                          className="p-2 rounded-xl border border-gray-150 dark:border-gray-800 text-gray-400 hover:text-primary hover:bg-gray-50 dark:hover:bg-gray-800 transition-all inline-block"
                        >
                          <LinkIcon size={16} />
                        </Link>
                        <button
                          ...
                          className="p-2 rounded-xl border border-gray-150 dark:border-gray-800 text-gray-400 hover:text-primary hover:bg-gray-50 dark:hover:bg-gray-800 transition-all inline-block cursor-pointer"
                        >
                          <Eye size={16} />
                        </button>
                        <Link
      ...
      {confirmModal.isOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm animate-in fade-in duration-200">
          <div className="bg-white dark:bg-gray-900 border border-gray-150 dark:border-gray-800 rounded-3xl p-6 max-w-md w-full shadow-2xl animate-in zoom-in-95 duration-200 space-y-6">
