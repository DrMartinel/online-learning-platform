...
export class CourseAdminController {
  ...
  @Post()
  @Auth('action:admin:course:create')
  ...
  @Put(':id')
  @Auth('action:admin:course:update')
  ...
  @Delete(':id')
  @Auth('action:admin:course:delete')
